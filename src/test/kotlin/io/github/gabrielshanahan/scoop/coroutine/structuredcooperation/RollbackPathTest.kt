    ...
    fun `failed rollbacks are well behaved n-deep`() {
        ...
        try {
            ...
            assertEquivalent(
                listOf(
                    CooperationExceptionData(
                        "[${childHandler1Coroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRollbackFailedException: Child rollback failure occurred while suspended in step [Rollback of 1 (rolling back child scopes)]",
            ...
            assertEquivalent(
                listOf(
                    CooperationExceptionData(
                        "[${rootHandlerCoroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRollbackFailedException: Child rollback failure occurred while suspended in step [Rollback of 1 (rolling back child scopes)]",
                        "io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRollbackFailedException",
                        rootHandlerCoroutine.identifier.asSource(),
                        listOf(
                            CooperationExceptionData(
