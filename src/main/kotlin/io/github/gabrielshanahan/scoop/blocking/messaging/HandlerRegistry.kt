 ...
 * 
 * The short version is that structured cooperation requires knowing which handlers exist
 * for each topic to determine when all message emissions have corresponding handler starts.
 * This interface provides the handler topology information needed to enforce the core
...
interface HandlerRegistry {
     ...
     * to determine when all handlers for emitted messages have started execution,
     * enabling structured cooperation synchronization.
     * 
