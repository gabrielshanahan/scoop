 ...
 * ## Execution Flow
 *
 * The [EventLoop][io.github.gabrielshanahan.scoop.blocking.coroutine.EventLoop] creates
 ...
 *    [EventLoop][io.github.gabrielshanahan.scoop.blocking.coroutine.EventLoop] with a result
 *    (suspend, success, or failure)
 *
 * See
 * [EventLoop.resumeCoroutine][io.github.gabrielshanahan.scoop.blocking.coroutine.EventLoop.resumeCoroutine]
 * for details.
 *
...
interface Continuation {
     ...
     *
     * This tells the [EventLoop][io.github.gabrielshanahan.scoop.blocking.coroutine.EventLoop] what
    ...
    sealed interface ContinuationResult {
         ...
         * [EventLoop][io.github.gabrielshanahan.scoop.blocking.coroutine.EventLoop] will initiate
