 ...
 *
 * As a consequence, the span of a [Continuation] in Scoop actually touches two steps - it
 * starts at the very end of the previous step, where we deal with any child failures, and then
 * proceeds to the next step, which it executes.
 * 
 * ## Execution Flow
 * 
...
interface Continuation {
    ...
    sealed interface ContinuationResult {
         ...
         * 
         * This is the normal result when a step completes successfully, regardless of whether
         * any messages were emitted.
         *
