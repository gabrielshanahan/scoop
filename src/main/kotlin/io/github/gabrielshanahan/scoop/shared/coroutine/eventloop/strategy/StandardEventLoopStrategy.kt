 ...
 * 
 * This strategy implements the core structured cooperation rule: sagas suspend execution
 * after emitting messages and don't continue until all handlers of those messages have
 * finished executing. It enforces this by checking that all message emissions have
 * corresponding handler starts before allowing sagas to resume, since the sql in
