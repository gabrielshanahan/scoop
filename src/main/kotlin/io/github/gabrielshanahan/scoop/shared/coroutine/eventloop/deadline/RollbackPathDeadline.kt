 ...
 * 
 * This cancellation token causes sagas to be cancelled if they exceed the specified
 * deadline while executing rollback steps. It does NOT apply during normal execution,
 * allowing the initial operation to complete even if rollback time limits are tight.
 * 
 * ## Usage in EventLoopStrategy
 * 
 * Used by [giveUpOnRollbackPath][io.github.gabrielshanahan.scoop.shared.coroutine.eventloop.strategy.EventLoopStrategy.giveUpOnRollbackPath]
 * via [rollbackDeadlineMissed][io.github.gabrielshanahan.scoop.shared.coroutine.eventloop.strategy.rollbackDeadlineMissed]
 ...
 * ## Trace Information
 *
 * The `trace` field maintains a complete history of all rollback path deadlines that were
 ...
 * 
 * This is the most common way to create rollback deadlines, specifying how long
 * rollback operations should be allowed to run.
 * 
 ...
 * 
 * Used when rollback operations should never be cancelled due to time limits,
 * typically for critical cleanup operations.
 * 
