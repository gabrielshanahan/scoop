 ...
 * deadline while executing normal steps. It does NOT apply during rollback execution,
 * allowing cleanup operations to continue even if the original operation timed out.
 * 
 * ## Usage in EventLoopStrategy
 * 
 * Used by [giveUpOnHappyPath][io.github.gabrielshanahan.scoop.shared.coroutine.eventloop.strategy.EventLoopStrategy.giveUpOnHappyPath]
 * via [happyPathDeadlineMissed][io.github.gabrielshanahan.scoop.shared.coroutine.eventloop.strategy.happyPathDeadlineMissed]
 ...
 * ## Trace Information
 *
 * The `trace` field maintains a complete history of all happy path deadlines that were
 ...
 * 
 * This is the most common way to create deadlines, specifying how long from
 * the current time the saga should be allowed to run.
 * 
