 ...
 * - **Database Access**: Uses FluentJDBC for database operations
 ...
 *
 * @see io.github.gabrielshanahan.scoop.messaging.PostgresMessageQueue
 * @see Message
 */
@ApplicationScoped
class MessageRepository(private val fluentJdbc: FluentJdbc) {
     ...
     *
     * @param connection The database connection within the current transaction
