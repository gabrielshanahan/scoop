 ...
 *   [EventLoop][io.github.gabrielshanahan.scoop.coroutine.EventLoop]
 ...
 * ## Execution Flow
 *
 * The [EventLoop][io.github.gabrielshanahan.scoop.coroutine.EventLoop] creates continuations and
 * resumes them with information about what happened in the previous step (success, failure, or
 ...
 *    [EventLoop][io.github.gabrielshanahan.scoop.coroutine.EventLoop] with a result (suspend,
 *    success, or failure)
 *
 * See
 * [EventLoop.resumeCoroutine][io.github.gabrielshanahan.scoop.coroutine.EventLoop.resumeCoroutine]
 * for details.
 *
...
interface Continuation {
    ...
    sealed interface LastStepResult {
         ...
         *    [TransactionalStep.rollback][io.github.gabrielshanahan.scoop.coroutine.TransactionalStep.rollback]
     ...
     *
     * This tells the [EventLoop][io.github.gabrielshanahan.scoop.coroutine.EventLoop] what happened
     * when the continuation was resumed and what should happen next.
     */
    sealed interface ContinuationResult {
         ...
         * [EventLoop][io.github.gabrielshanahan.scoop.coroutine.EventLoop] will initiate rollback
         * processing or mark the saga as failed, depending on the current execution state.
         */
