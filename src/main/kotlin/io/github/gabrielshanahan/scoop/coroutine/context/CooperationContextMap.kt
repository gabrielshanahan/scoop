 ...
 * like [TryFinallyElement][io.github.gabrielshanahan.scoop.coroutine.builder.TryFinallyElement] and
 * [CancellationToken] to implement custom merging behaviors rather than just simple replacement.
 *
...
data class CooperationContextMap(
     ...
     * [TryFinallyElement][io.github.gabrielshanahan.scoop.coroutine.builder.TryFinallyElement] list
     * merging and [CancellationToken] logical AND.
     *
     * **Combining Strategy**:
