 ...
 * which is run
 * [periodically, or when NOTIFIED by Postgres][io.github.gabrielshanahan.scoop.messaging.PostgresMessageQueue.subscribe].
 *
 * ## How It Works
 *
 ...
 *    [EventLoopStrategy.resumeHappyPath][io.github.gabrielshanahan.scoop.coroutine.eventloop.strategy.EventLoopStrategy.resumeHappyPath]
 *    and
 *    [EventLoopStrategy.resumeRollbackPath][io.github.gabrielshanahan.scoop.coroutine.eventloop.strategy.EventLoopStrategy.resumeRollbackPath]).
            ...
            whileISaySo { repeatCount, saySo ->
                fluentJdbc.transactional { connection ->
                    try {
                        ...
                        logger.error(
                            "[${connection.backendPID()}] Error when running coroutine ${distributedCoroutine.identifier}",
                            e,
                        )
                        throw e
                    }
