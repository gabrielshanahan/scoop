package io.github.gabrielshanahan.scoop.coroutine.eventloop.strategy
 ...
 * [HandlerRegistry][io.github.gabrielshanahan.scoop.messaging.HandlerRegistry] and demonstrates the
 * basic principles.
 *
 * ## SQL Generation
 *
 ...
 * [finalSelect][io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.finalSelect]
 *
 ...
 * due to the
 * [giveUpIfNecessary][io.github.gabrielshanahan.scoop.coroutine.continuation.BaseCooperationContinuation.giveUpIfNecessary]
 * checks in
 * [BaseCooperationContinuation.resumeCoroutine][io.github.gabrielshanahan.scoop.coroutine.continuation.BaseCooperationContinuation.resumeCoroutine].
 */
interface EventLoopStrategy {
     ...
     * [MessageEventRepository.startContinuationsForCoroutine][io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.MessageEventRepository.startContinuationsForCoroutine].
     *
     ...
     *   [CooperationFailures][io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.CooperationFailure]
 ...
 * - [Cancellation
 *   requests][io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.StructuredCooperationCapabilities.cancel]
 *   (not to be confused with
 *   [CancellationTokens][io.github.gabrielshanahan.scoop.coroutine.context.CancellationToken])
 * - Various deadlines (which are special cases of
 *   [CancellationTokens][io.github.gabrielshanahan.scoop.coroutine.context.CancellationToken])
 * - A pedagogical implementation of `start`
 *
 * See
 * [HappyPathDeadline][io.github.gabrielshanahan.scoop.coroutine.eventloop.deadline.HappyPathDeadline],
 * [RollbackPathDeadline][io.github.gabrielshanahan.scoop.coroutine.eventloop.deadline.RollbackPathDeadline]
 * and
 * [AbsoluteDeadline][io.github.gabrielshanahan.scoop.coroutine.eventloop.deadline.AbsoluteDeadline]
