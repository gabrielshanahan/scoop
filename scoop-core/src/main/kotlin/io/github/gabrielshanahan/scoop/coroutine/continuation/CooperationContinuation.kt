...
internal abstract class BaseCooperationContinuation(
     ...
     *    [EventLoop.mark][io.github.gabrielshanahan.scoop.coroutine.EventLoop.mark])
     * 2. **Rollback events**: ROLLING_BACK/ROLLED_BACK events are attributed to the current step
     *    (see [EventLoop.mark][io.github.gabrielshanahan.scoop.coroutine.EventLoop.mark])
     ...
     * [CooperationFailure][io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.CooperationFailure]
     * objects. These get processed by
     * [MessageEventRepository.fetchGiveUpExceptions][io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.MessageEventRepository.fetchGiveUpExceptions]
     * and converted to
     * [CooperationException][io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.CooperationException]s.
     *
     ...
     *   [BaseEventLoopStrategy.giveUpOnHappyPath][io.github.gabrielshanahan.scoop.coroutine.eventloop.strategy.BaseEventLoopStrategy.giveUpOnHappyPath]
     * - [RollbackPathContinuation.giveUpStrategy]: Uses
     *   [BaseEventLoopStrategy.giveUpOnRollbackPath][io.github.gabrielshanahan.scoop.coroutine.eventloop.strategy.BaseEventLoopStrategy.giveUpOnRollbackPath]
     *
     * For SQL examples, see
     * [cancellationRequested][io.github.gabrielshanahan.scoop.coroutine.eventloop.strategy.cancellationRequested]
     * and
     * [deadlineMissed][io.github.gabrielshanahan.scoop.coroutine.eventloop.strategy.deadlineMissed]
     * functions.
     *
