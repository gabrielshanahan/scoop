...
/**
 * CooperationContextModule - Custom Jackson module for lazy deserialization of
 * [CooperationContext].
 *
 * This module implements the Jackson plumbing required to achieve lazy deserialization of
 ...
 * [CooperationContext]. This module ensures that:
 ...
 *    [MappedKey][io.github.gabrielshanahan.scoop.coroutine.context.CooperationContext.MappedKey]
 *
 * ## Usage
 *
 * ```kotlin
 ...
 * - [OpaqueElement][io.github.gabrielshanahan.scoop.coroutine.context.CooperationContext.OpaqueElement]:
 *   Write raw JSON directly (no re-serialization)
 * - [MappedElement][io.github.gabrielshanahan.scoop.coroutine.context.CooperationContext.MappedElement]:
 ...
 *   deserialization
 */
class CooperationContextModule(private val objectMapper: ObjectMapper) :
    SimpleModule("CooperationContextModule") {
        ...
        setSerializerModifier(
            object : BeanSerializerModifier() {
                override fun modifySerializer(
                    ...
                    if (CooperationContext::class.java.isAssignableFrom(beanDesc.beanClass)) {
