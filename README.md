...
TODO: Remove .junie and current "Implementation.md"  and instead replace it with a current generated view, or use that "generate AI docs" thing.
TODO: Go through notes and update anything necessary
TODO: Add TOC
...
### How do I grok it?
Start by reading the articles above. Then, read the overview bellow and gain a high-level understanding of how Scoop is structured. Continue by
learning about how structured cooperation is implemented, along with the core of how the messaging system works—coroutines, continuations, and the event loop.
...
functionalities—cooperation context, sleeping, deadlines, etc. The diagram below provides a good path to take through the code.
