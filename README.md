...
## TL;DR
This repository contains Scoop, a proof-of-concept implementation of **structured cooperation**. To understand what that is, read
...
read about [the important components](#important-components-and-high-level-flow) and use the diagram to navigate the codebase.
