...
// build.gradle.kts
dependencies {
    implementation("io.github.gabrielshanahan:scoop-core:0.4.0")
}
```
...
<dependency>
    ...
    <version>0.4.0</version> <!-- scoop-version -->
</dependency>
```
...
// build.gradle.kts
dependencies {
    implementation("io.github.gabrielshanahan:scoop-quarkus:0.4.0")
}
```
