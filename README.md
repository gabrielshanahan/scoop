...
// build.gradle.kts
dependencies {
    implementation("io.github.gabrielshanahan:scoop-core:0.2.1")
}
```
...
<dependency>
    ...
    <version>0.2.1</version> <!-- scoop-version -->
</dependency>
```
...
// build.gradle.kts
dependencies {
    implementation("io.github.gabrielshanahan:scoop-quarkus:0.2.1")
}
```
