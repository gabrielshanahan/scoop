...
import io.github.gabrielshanahan.scoop.coroutine.CooperationExceptionData
    ...
    fun `rollbacks are well behaved n-deep`() {
        ...
        try {
            ...
            assertEquivalent(
                listOf(
                    CooperationExceptionData(
                        "[${rootHandlerCoroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRolledBackException: Child failure occurred while suspended in step [1]",
                        "io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRolledBackException",
            ...
            assertEquivalent(
                listOf(
                    CooperationExceptionData(
                        "[${rootHandlerCoroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.ParentSaidSoException: <no message>",
                        "io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.ParentSaidSoException",
                        rootHandlerCoroutine.identifier.asSource(),
                        listOf(
                            CooperationExceptionData(
                                "[${rootHandlerCoroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRolledBackException: Child failure occurred while suspended in step [1]",
            ...
            assertEquivalent(
                listOf(
                    CooperationExceptionData(
                        "[${childHandler1Coroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.ParentSaidSoException: <no message>",
                        "io.github.gabrielshanahan.scoop.coroutine.structuredcooperation.ParentSaidSoException",
    ...
    fun `failed rollbacks are well behaved n-deep`() {
        ...
        try {
            ...
            assertEquivalent(
                listOf(
                    CooperationExceptionData(
                        "[${childHandler1Coroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRollbackFailedException: Child rollback failure occurred while suspended in step [Rollback of 1[0,] (rolling back child scopes)]",
                        "io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRollbackFailedException",
                        childHandler1Coroutine.identifier.asSource(),
                        listOf(
                            CooperationExceptionData(
                                "[${grandChildCoroutine.identifier.asSource()}] java.lang.IllegalStateException: Rollback failure",
            ...
            assertEquivalent(
                listOf(
                    CooperationExceptionData(
                        "[${rootHandlerCoroutine.identifier.asSource()}] io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRollbackFailedException: Child rollback failure occurred while suspended in step [Rollback of 1[0,] (rolling back child scopes)]",
                        "io.github.gabrielshanahan.scoop.coroutine.eventloop.ChildRollbackFailedException",
                        rootHandlerCoroutine.identifier.asSource(),
                        listOf(
                            CooperationExceptionData(
